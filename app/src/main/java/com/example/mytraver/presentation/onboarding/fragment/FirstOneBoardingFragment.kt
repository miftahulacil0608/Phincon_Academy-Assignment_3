...
class FirstOneBoardingFragment : Fragment() {
    private var _binding: FragmentFirstOneBoardingBinding ?=null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFirstOneBoardingBinding.inflate(inflater, container, false)
        return binding.root
    }
